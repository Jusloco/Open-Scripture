...
import { getMarkBookData, getMarkVersesByChapter } from '@/lib/data'
import ConfidenceBadge from '@/components/ConfidenceBadge'
import type { Metadata } from 'next'

export const metadata: Metadata = {
  title: 'Gospel of Mark — Manuscript Overview',
  description: 'Browse all 16 chapters of the Gospel of Mark and see the manuscript evidence for every chapter.',
}

export default function MarkPage() {
  const book = getMarkBookData()
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16">
      ...
      <div className="mb-12">
        ...
        <h1 className="text-4xl font-bold text-zinc-900 mb-4">Gospel of Mark</h1>
        <p className="text-zinc-500 leading-relaxed max-w-2xl">
          The Gospel of Mark is the shortest of the four Gospels and widely considered the earliest. It is one of the best-attested texts in ancient history. Below are all 16 chapters. Click any chapter to browse its verses and see the manuscript evidence.
        </p>
      ...
      <div className="space-y-3">
        {book.chapters.map(chapter => {
          const keyVerses = getMarkVersesByChapter(chapter.number)
