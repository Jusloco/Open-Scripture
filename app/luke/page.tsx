...
import { getLukeBookData, getLukeVersesByChapter } from '@/lib/data'
import ConfidenceBadge from '@/components/ConfidenceBadge'
import type { Metadata } from 'next'

export const metadata: Metadata = {
  title: 'Gospel of Luke — Manuscript Overview',
  description: 'Browse all 24 chapters of the Gospel of Luke and see the manuscript evidence for every chapter.',
}

export default function LukePage() {
  const book = getLukeBookData()
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16">
      ...
      <div className="mb-12">
        ...
        <h1 className="text-4xl font-bold text-zinc-900 mb-4">Gospel of Luke</h1>
        <p className="text-zinc-500 leading-relaxed max-w-2xl">
          The Gospel of Luke is the longest of the four Gospels and part of a two-volume work with the Acts of the Apostles. It is one of the best-attested texts in ancient history. Below are all 24 chapters. Click any chapter to browse its verses and see the manuscript evidence.
        </p>
      ...
      <div className="space-y-3">
        {book.chapters.map(chapter => {
          const keyVerses = getLukeVersesByChapter(chapter.number)
